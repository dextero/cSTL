...
#   define TreeKeyType KeyType
#   define TreeKeyTypeString KeyTypeString
#   define TreeValueType ValueType
#   define TreeValueTypeString ValueTypeString
#   include "rbtree.h"
...
#   define RBTREE_METHOD(name)      METHOD_TEMPLATE2(rbtree, KeyTypeString, ValueTypeString, name)
